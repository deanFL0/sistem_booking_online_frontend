...
import { GuestCancelBookingDialog } from "~/features/bookings/components/guest-cancel-booking-dialog";
import { GuestRescheduleBookingDialog } from "~/features/bookings/components/guest-reschedule-booking-dialog";
...
export default function GuestBookingDetailPage() {
    ...
    const { data: booking, isLoading, isError } = useQuery({
        ...
        queryFn: async () => {
            return bookingApi.guestBooking(token!);
        },
        enabled: !!token,
    });
                    ...
                    <CardContent className="space-y-6">
                        ...
                        {canModify && (
                            <div className="flex flex-col gap-3 md:flex-row">
                                <GuestCancelBookingDialog booking={booking} token={token!} />
                                <Button
